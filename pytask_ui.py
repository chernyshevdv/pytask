...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        item = QtWidgets.QTableWidgetItem()
        self.table_projects.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_projects.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_projects.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_projects.setHorizontalHeaderItem(6, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "status"))
        item = self.table_projects.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Open"))
        item = self.table_projects.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "WIP"))
        item = self.table_projects.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Closed"))
        item = self.table_projects.horizontalHeaderItem(6)
